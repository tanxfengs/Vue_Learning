...
! function (t, e) {
                                    ...
                                    r.push.apply(r, function (t, e, n, o) {
                                        ...
                                        if (E(r) && "" !== r)
                                            if ("string" == typeof r || "number" ==
                                                typeof r || "boolean" == typeof r) r =
                                                r.toString(), o && "*" !== o && (r = r.substring(
                                                    0, parseInt(o, 10))), i.push(O(e, r,
                                                    P(e) ? n : null));
                                            else if ("*" === o) Array.isArray(r) ? r.filter(
                                            ...
                                            Array.isArray(r) ? r.filter(E).forEach(
                                                ...
                                                encodeURIComponent(n) + "=" + s.join(
                                                    ",")) : 0 !== s.length && i.push(
                                                s.join(","))
                                        } else ";" === e ? i.push(encodeURIComponent(n)) :
                                            "" !== r || "&" !== e && "?" !== e ? "" ===
                                            r && i.push("") : i.push(encodeURIComponent(
                                                n) + "=");
                                        return i
    ...
    function U(i) {
        return new c(function (o) {
            ...
            i.abort = function () {
                    return r.abort()
                }, r.open(i.method, i.getUrl()), i.timeout && (r.timeout = i.timeout), r.onload = t, r.onabort =
                t, r.onerror = t, r.ontimeout = t, r.onprogress = function () {}, r.send(i.getBody())
        })
    }
    $.options = {
        url: "",
        ...
        root: function (t, e) {
            var n, o, r = e(t);
            return d(t.root) && !/^(https?:)?\//.test(r) && (n = t.root, o = "/", r = (n && void 0 === o ?
                    n.replace(/\s+$/, "") : n && o ? n.replace(new RegExp("[" + o + "]+$"), "") : n) +
                "/" + r), r
        }
        ...
        return e.add = function (t, e) {
            ...
            function n(o, t, r) {
                var i, s = h(t),
                    u = y(t);
                g(t, function (t, e) {
                    i = m(t) || h(t), r && (e = r + "[" + (u || i ? e : "") + "]"), !r && s ? o.add(t.name,
                        t.value) : i ? n(o, t, e) : o.add(e, t)
                })
            }(e, t), e.join("&").replace(/ /g, "+")
    }, $.parse = function (t) {
    ...
    function n(u) {
        return new c(function (o) {
            ...
            t = function (t) {
                ...
                }, u.params[e] = i, u.timeout && setTimeout(u.abort, u.timeout), (r = document.createElement(
                    "script")).src = u.getUrl(), r.type = "text/javascript", r.async = !0, r.onload = t, r.onerror =
    ...
    function A(r) {
        return new c(function (n) {
            ...
            r.abort = function () {
                ...
                "responseType" in o && (o.responseType = r.responseType), (r.withCredentials || r.credentials) &&
                (o.withCredentials = !0), r.crossOrigin || r.headers.set("X-Requested-With",
                    "XMLHttpRequest"), l(r.progress) && "GET" === r.method && o.addEventListener("progress",
                    r.progress), l(r.downloadProgress) && o.addEventListener("progress", r.downloadProgress),
    ...
    var q = function (t, e) {
        var n, o, r, i = e.url,
            ...
            u = e.status,
            a = e.statusText;
        this.url = i, this.ok = 200 <= u && u < 300, this.status = u || 0, this.statusText = a || "", this.headers =
            new I(s), d(this.body = t) ? this.bodyText = t : (r = t, "undefined" != typeof Blob && r instanceof Blob &&
                (this.bodyBlob = t, (0 === (o = t).type.indexOf("text") || -1 !== o.type.indexOf("json")) && (
                    this.bodyText = (n = t, new c(function (t) {
    ...
    function M(t) {
                ...
                function t(t) {
                    for (; s.length;) {
                        ...
                        if (l(e)) {
                            ...
                            l(o) && u.unshift(o)
                        } else r = "Invalid interceptor of type " + typeof e + ", must be a function", "undefined" !=
                            typeof console && a && console.warn("[VueResource warn]: " + r)
                    }
                    var r
                }
        ...
        return function (n) {
            ...
            var e;
            return t instanceof Error && (e = t, "undefined" != typeof console && console.error(e)), c.reject(
                t)
        })
    }
    ...
    return M.options = {}, M.headers = {
            ...
            return m(t.body) && 0 === e.indexOf("application/json") && (t.body = JSON.stringify(t.body)),
                function (o) {
                    return o.bodyText ? v(o.text(), function (t) {
                        var e, n;
                        if (0 === (o.headers.get("Content-Type") || "").indexOf("application/json") ||
                            (n = (e = t).match(/^\s*(\[|\{)/)) && {
                                "[": /]\s*$/,
                                "{": /}\s*$/
                            } [n[1]].test(e)) try {
        ...
        form: function (t) {
            ...
            e = t.body, "undefined" != typeof FormData && e instanceof FormData ? t.headers.delete(
                "Content-Type") : m(t.body) && t.emulateJSON && (t.body = $.params(t.body), t.headers.set(
